...
!-----------------------------------------------------------------------
  ...
  !----------------------F.-M. Yuan (2018-03-23): user-defined parameter file ---------------------------------------------------------------------
    ...
    ! but cannot less (i.e. pft numbers in 'surfdata'<= that in 'parameters').
    ! NOTE: 'mxpft' is the max. index for prameter variable array (0:mxpft), which must be not less than 'npft-1'
    if (npft<maxpatch_pft) call endrun(msg=' ERROR: pft number less than maxpatch_pft: '//errMsg(__FILE__, __LINE__))
  ...
  !----------------------F.-M. Yuan (2018-03-23): user-defined parameter file ---------------------------------------------------------------------
    ...
    if( (.not. use_fates) .and. crop_prog) then
       ...
       if ( npcropmax /= maxpatch_pft-1 )then
    !----------------------F.-M. Yuan: 2018-03-23---------------------------------------------------------------------
